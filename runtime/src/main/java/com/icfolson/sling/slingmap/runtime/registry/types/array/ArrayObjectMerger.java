...
public class ArrayObjectMerger extends ClassObjectMerger {

    public static final ArrayObjectMerger INSTANCE = new ArrayObjectMerger();

    private ArrayObjectMerger() { }
    ...
    protected void doMerge(final Object object, final Resource resource, final MergeContext mergeContext)
        ...
        final Iterator objectIterator = Arrays.asList(objArray).iterator();
